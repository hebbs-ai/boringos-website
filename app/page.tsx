...
const features = [
  ...
  },
  {
    ...
    description: "AI assistant that can operate your system AND build new features. Chat interface — ask it to create tasks, query data, or edit your code.",
    accent: "var(--accent)",
  },
  {
    title: "Data Sync",
    description: "Workflow-triggered sync for email, calendar, Slack. for-each + create-inbox-item pattern. Dedup built in. Agents process from inbox.",
    accent: "var(--accent-2)",
  },
];
  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden">
      ...
      <section className="relative z-10 px-6 py-24 border-t border-[var(--border)]">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-[var(--muted)] mb-12 max-w-xl mx-auto">
            Agents don&apos;t just execute — they delegate, escalate, and collaborate.
            Watch your AI workforce coordinate in real time.
          </p>
          <div className="relative bg-[var(--code-bg)] border border-[var(--border)] rounded-2xl overflow-hidden neon-border">
            <AgentOrchestra />
          </div>
          <div className="grid md:grid-cols-3 gap-4 mt-8">
            <div className="border border-[var(--border)] rounded-xl p-5 bg-[var(--code-bg)] card-hover">
              ...
              <p className="text-sm text-[var(--muted)]">CEO sets the goal. CTO breaks it down. Engineers execute. QA validates. No human in the loop.</p>
            </div>
            <div className="border border-[var(--border)] rounded-xl p-5 bg-[var(--code-bg)] card-hover">
              ...
              <p className="text-sm text-[var(--muted)]">Every agent remembers. Every run builds context. Patterns emerge across hundreds of tasks.</p>
            </div>
            <div className="border border-[var(--border)] rounded-xl p-5 bg-[var(--code-bg)] card-hover">
      ...
      <section className="relative z-10 px-6 py-24 border-t border-[var(--border)]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">
            Your app ships with an <span style={{ color: "var(--accent)" }}>AI copilot</span>
          </h2>
          <p className="text-center text-[var(--muted)] mb-16 max-w-lg mx-auto">
            Every BoringOS app gets a built-in copilot that can operate your system and build new features. Zero config.
          </p>
            ...
            <div className="p-6 space-y-4 text-sm">
              ...
              <div className="flex gap-3">
                ...
                <div className="border border-[var(--border)] rounded-xl px-4 py-2 max-w-[70%] text-[var(--muted)]">
                  Found 1 blocked task:<br/><br/>
                  <span style={{ color: "var(--accent)" }}>BOS-005</span> — LinkedIn and Twitter Post<br/>
                  <span className="text-xs">Blocked: needs web search access to research today&apos;s news</span>
                </div>
              </div>
              <div className="flex justify-end">
                <div className="bg-[var(--accent)] text-[var(--background)] rounded-xl px-4 py-2 max-w-[70%]">
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-8">
            <div className="border border-[var(--border)] rounded-xl p-4 bg-[var(--code-bg)] text-center">
              ...
              <div className="text-xs text-[var(--muted)]">Query data, manage entities, diagnose issues</div>
            </div>
            <div className="border border-[var(--border)] rounded-xl p-4 bg-[var(--code-bg)] text-center">
              <div className="text-2xl mb-1">🛠</div>
              <div className="text-xs text-[var(--muted)]">Edit code, add features, fix bugs — from chat</div>
            </div>
            <div className="border border-[var(--border)] rounded-xl p-4 bg-[var(--code-bg)] text-center">
              <div className="text-2xl mb-1">0️⃣</div>
              <div className="text-xs text-[var(--muted)]">Zero config — ships with every app automatically</div>
            </div>
          </div>
        </div>
      </section>
